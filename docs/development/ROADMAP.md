...
| P0.5 | Circulation | PARTIAL | Transactional service paths exist; Loans tab now reads live scoped PostgreSQL data and metrics; mutation actions, other queues and full UI integration remain |
